...
PGRFCloseResPkt::PGRFCloseResPkt(U32 e, U32 handle, B8 ok, U8 subtype)
...
PGRFCloseResPkt::PGRFCloseResPkt(U8 subtype):PPacketBase( PMyPktDef::MY_MAJOR_PKT,subtype )
{

}

U32		PGRFCloseResPkt::serialize( S8 *  buf,  S32 offset ) const 
{
...
U32		PGRFCloseResPkt::deserialize( const S8 * buf, S32 offset )
{
...
U32 PGRFCloseResPkt::getLength() const 
{
...
String	PGRFCloseResPkt::toString() const 
{
...
U32	PGRFCloseResPkt::toString(S8 * str)const
{
...
PGRFCloseResPkt::~PGRFCloseResPkt(void)
{
