...
PGRFLeaderLocationResPkt::PGRFLeaderLocationResPkt(U32 sessionID, const Network::PInetAddr& addr, U8 subtype)
...
PGRFLeaderLocationResPkt::PGRFLeaderLocationResPkt(U8 subtype):PPacketBase( PMyPktDef::MY_MAJOR_PKT,subtype )
{

}

U32		PGRFLeaderLocationResPkt::serialize( S8 *  buf,  S32 offset ) const 
{
...
U32		PGRFLeaderLocationResPkt::deserialize( const S8 * buf, S32 offset )
{
...
U32 PGRFLeaderLocationResPkt::getLength() const 
{
...
String	PGRFLeaderLocationResPkt::toString() const 
{
...
U32	PGRFLeaderLocationResPkt::toString(S8 * str)const
{
...
PGRFLeaderLocationResPkt::~PGRFLeaderLocationResPkt(void)
{
